...
if [ $(uname) = "Darwin" ]; then
  clang++ main.cpp apiprocess/process.cpp -o xproc -std=c++17 -DPROCESS_GUIWINDOW_IMPL -DPROCESS_XQUARTZ_IMPL `pkg-config x11 --cflags --libs` -m32;
  ...
  C:/msys64/msys2_shell.cmd -defterm -mingw32 -no-start -here -lc "g++ main.cpp apiprocess/process.cpp -o xproc.exe -std=c++17 -static-libgcc -static-libstdc++ -static -lShlwapi -DPROCESS_WIN32EXE_INCLUDES -DPROCESS_GUIWINDOW_IMPL -m32";

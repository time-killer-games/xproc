...
if [ $(uname) = "Darwin" ]; then
  clang++ main.cpp apiprocess/process.cpp -o xproc -std=c++17 -DPROCESS_GUIWINDOW_IMPL -framework Cocoa -framework CoreFoundation -framework CoreGraphics -arch arm64 -arch x86_64;

...
if [ $(uname) = "Darwin" ]; then
  clang++ main.cpp apiprocess/process.cpp -o xproc -std=c++17 -ObjC++ -DPROCESS_GUIWINDOW_IMPL -framework AppKit -framework CoreFoundation -framework CoreGraphics -arch arm64 -arch x86_64;
  ...
  g++ main.cpp apiprocess/process.cpp -o xproc.exe -std=c++17 -static-libgcc -static-libstdc++ -static -DPROCESS_WIN32EXE_INCLUDES -DPROCESS_GUIWINDOW_IMPL;

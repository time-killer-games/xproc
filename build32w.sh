...
if [ $(uname) = "Darwin" ]; then
  clang++ main.cpp crossprocess.cpp -o xproc -std=c++17 -DXPROCESS_GUIWINDOW_IMPL -framework CoreFoundation  -framework CoreGraphics -m32;
  ...
  C:/msys64/msys2_shell.cmd -defterm -mingw32 -no-start -here -lc "g++ main.cpp crossprocess.cpp -o xproc.exe -std=c++17 -static-libgcc -static-libstdc++ -static -lShlwapi -DXPROCESS_WIN32EXE_INCLUDES -DXPROCESS_GUIWINDOW_IMPL -m32 -g -ggdb";
